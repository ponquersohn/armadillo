...
#define ARMADILLO_IOCTL_TOGGLE_PID_UNKILLABLE       _IOW    (ARMADILLO_IOCTL_MAGIC, 3, struct armadillo_ioctl_toggle_pid_unkillable)
#define ARMADILLO_IOCTL_TOGGLE_DEBUG                _IO     (ARMADILLO_IOCTL_MAGIC, 4)
