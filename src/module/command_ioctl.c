...
long armadillo_unlocked_ioctl(struct file *filp, unsigned int ioctl_num, unsigned long ioctl_arg)
{
    ...
    case ARMADILLO_IOCTL_LOCK:
    {
        ...
        APRINTK(KERN_INFO "armadillo: armadillo_ioctl_lock: called.");
        ...
        // lets force null terminate the string
        ...
        armadillo_ioctl_lock_params.secret[ARMADILLO_MAX_PASS_LENGTH] = '\0';
    ...
    case ARMADILLO_IOCTL_UNLOCK:
    {
        ...
        APRINTK(KERN_INFO "armadillo: armadillo_ioctl_unlock: called.");
